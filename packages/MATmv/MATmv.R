#' MATmv: Selección y análisis de datos faltantes
#'
#' Esta función selecciona columnas específicas de un dataframe, crea un nuevo dataframe con casos completos y genera información sobre los datos faltantes.
#'
#' @param dataframe Un dataframe.
#' @param columnas Un vector de nombres de columnas a seleccionar.
#' @return El nombre del nuevo dataframe con casos completos.
#' @export
